...
var shoppingView = (function($){
    ...
    function topicToRow(topic){
        ...
        "<tr><td>"+topic.action+
        "</td><td>"+ 
            "<input type='text' value='"+topic.price+"' sid='"+topic.id+"' onchange='shoppingApp.editPrice(this)'>"+
        "</td><td>"+
            "<input type='text' value='"+topic.quantity+"' sid='"+topic.id+"' onchange='shoppingApp.editQuantity(this)'>"+
        "</td><td>"+topic.quantity * topic.price +
