...
function recognize(){
    ...
    function errorCheck(counter) {
        if (counter % 3 == 0) {
            alert("I'm sorry, I'm having trouble understanding you. You can try speaking the problem again or typing the problem.")
        }
    }
    function successCallback(results){
    	...
    	if (speechTranscript.indexOf("where") > -1) {
            countWhere++;
